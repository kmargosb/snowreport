  ...
  return (
    <div className={`h-screen bg-slate-100 ${isMobileView ? 'flex flex-col mt-[90px]' : 'flex'}`}>
      {isMobileView ? (
        ...
        <div className='w-[300px] py-16 h-full left-0 bg-slate-50 shadow-md shadow-primary2 flex flex-col justify-between items-center'>
      ...
      <div className='flex items-center gap-2'>
        {selectedComponent === 'Profile' && <ProfileUser />}
